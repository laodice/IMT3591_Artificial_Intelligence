...
\algblockdefx[CUSREPEAT]{Cus}{EndCus}
[0]{\textbf{repeat}}
[0]{\textbf{every day}}
...
%\algdef{SE}[REPEATEVERYDAY]{Repeatt}{EveryDay}{Repeat}[1]{Every day}%
\algrenewcommand{\algorithmiccomment}[1]{\hfill // \begin{minipage}[t]{0.25\textwidth}#1\end{minipage}}
